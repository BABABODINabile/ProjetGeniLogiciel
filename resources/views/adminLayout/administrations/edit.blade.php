...
@section('page_title', 'Édition Membre')

@section('content')
<div class="max-w-4xl mx-auto px-4">
    <form action="{{ route('administrations.update', $administration->id) }}" method="POST" class="space-y-4">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 gap-4">
                <div>
                    ...
                    <input type="text" name="nom" value="{{ old('nom', $administration->nom) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="prenom" value="{{ old('prenom', $administration->prenom) }}" required
                        class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 outline-none transition-all text-sm">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $administration->user->email ?? '') }}" required
                        class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 outline-none transition-all text-sm">
                ...
                <div>
                    ...
                    <input type="text" name="fonction" value="{{ old('fonction', $administration->fonction) }}" required
                        class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 outline-none transition-all text-sm">
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $administration->user->is_active ?? true) ? 'checked' : '' }} class="mr-2">
