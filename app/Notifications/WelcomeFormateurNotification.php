...
class WelcomeFormateurNotification extends Notification
{
    use Queueable;
    ...
    {
        $firstName = $notifiable->formateur->prenom ?? '';

        return (new MailMessage)
            ->subject('Bienvenue sur NomPlatform - Vos accès')
            ->greeting('Bonjour ' . ($firstName ?: ''))
            ->line('Votre compte formateur a été créé par l\'administration.')
